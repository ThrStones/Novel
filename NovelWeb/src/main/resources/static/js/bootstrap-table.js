...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        pagination: false,
        sidePagination: 'demo', // demo or server
        ...
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s 条数据/页', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('%s 到 %s 共 %s 行', pageFrom, pageTo, totalRows);
        },
...
/*        formatLoadingMessage: function () {
        ...
        onClickRow: function (item, $element) {
            $.ajax({
                type: "GET",
                url: "../demo/getDemoById",
                data: {demoId:item.demoId},
                dataType: "json",
                success: function(data){
                    $("#addFormDiv").attr('style', 'display : block;margin-top: 30px');

                    $("#title-add").removeClass("div-block");
                    $("#title-add").addClass("div-none");
                    $("#btn-add").removeClass("div-block");
                    $("#btn-add").addClass("div-none");

                    $("#title-edit").removeClass("div-none");
                    $("#title-edit").addClass("div-block");
                    $("#btn-edit").removeClass("div-none");
                    $("#btn-edit").addClass("div-block");
                    ...
                    $("#btn-delete").attr("onclick","deleteDemo("+ data.demoId +")");
                }
            });
        },
